...
class SignupScreenSt extends StatefulWidget {
  @override
  _SignupScreenStateSt createState() => _SignupScreenStateSt();
}

class _SignupScreenStateSt extends State<SignupScreenSt> {
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>LoginScreenSt()));//signup screen
                    },
                  )
                ],
              ),
