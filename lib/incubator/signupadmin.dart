...
class SignupScreenAd extends StatefulWidget {
  @override
  _SignupScreenStateAd createState() => _SignupScreenStateAd();
}

class _SignupScreenStateAd extends State<SignupScreenAd> {
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>LoginScreenAd()));//signup screen
                    },
                  )
                ],
              ),
