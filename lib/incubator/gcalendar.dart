...
//     clientId:
//     '867988330689-111rqbs6uom0a48o3bb9keqm5l9kd0a4.apps.googleusercontent.com',
//     scopes: <String>[
...
//     GoogleAPIClient(await googleUser?.authHeaders as Map<String, String>);
...
//       for (int i = 0; i < (calEvents.items?.length as int); i++) {
...
//     final googleAPI.Event event = appointments![index];
//     return (event.summary == null || event.summary!.isEmpty ? 'No Title' : event.summary) as String;
//   }
// }
//
